...
def test_wide_field_is_not_linear_graph_projection() -> None:
    result = project_perceptual_live_view(300.0, 30.0, 270.0, 120.0)
    linear_x = 0.5 + 30.0 / 120.0
    assert result.visible is True
    assert abs(result.x_fraction - linear_x) > 0.01
