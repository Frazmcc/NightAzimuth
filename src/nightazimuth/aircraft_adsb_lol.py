...
class AdsbLolProvider:
    ...
    def fetch_snapshot(
        ...
        # adsb.lol's point endpoint uses nautical miles. Keep requests bounded
        # around the selected observer instead of fetching global traffic.
...
def _normalise_record(
    ...
    try:
        return AircraftObservation(
            ...
            contact_observed_at=contact_observed_at,
